...
const SaveStatusModal: React.FC<SaveStatusModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-[10000] backdrop-blur-sm bg-black/30 animate-fadeIn">
      <div className="bg-gray-900 rounded-xl p-8 shadow-[0_20px_60px_rgba(0,0,0,0.8)] animate-slideUp">
        {status === "loading" && (
