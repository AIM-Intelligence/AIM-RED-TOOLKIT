...
export default function NodeMaker({ isOpen, onClose }: ModalProps) {
  useEffect(() => {
    if (isOpen) {
  ...
  return (
    ...
    >
      <div
        className="relative bg-[#0a0a0a] rounded-xl max-w-[70vw] max-h-[70vh] overflow-auto shadow-[0_20px_60px_rgba(0,0,0,0.8)] animate-slideUp min-w-[400px] min-h-[200px] sm:min-w-[90vw] sm:mx-4"
